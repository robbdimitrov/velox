  ...
  <div class="glass-panel max-w-md w-full relative">
    ...
    <div class="p-6">
      <div class="flex items-center gap-3 mb-6 border-b border-white/10 pb-4">
        ...
        <h3 class="text-lg font-black uppercase tracking-wider text-white">Invite Staff</h3>
      </div>
      
      <div class="space-y-4">
        <label class="form-control">
          <span class="label-text text-inkMuted font-medium mb-1">Email Address</span>
          <div class="flex items-center gap-2 border border-white/10 bg-black/40 px-3 py-2 rounded-lg focus-within:border-signal transition-colors">
