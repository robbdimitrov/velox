    ...
    <div class="relative z-10">
      ...
      <form onsubmit={handleSubmit} class="space-y-6">
        ...
        <button
          type="submit"
          disabled={loading}
          class="w-full btn border-none bg-gradient-to-r from-signal to-accent text-white rounded shadow-lg shadow-signal/20 hover:shadow-signal/40 hover:scale-[1.02] transition-all flex items-center justify-center gap-2"
        >
          {#if loading}
